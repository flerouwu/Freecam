...
public class Freecam {
    ...
    private static void onEnableFreecam() {
        ...
        freeCamera.applyPerspective((FreecamConfig.Perspective) FreecamConfig.PERSPECTIVE.get(), FreecamConfig.ALWAYS_CHECK_COLLISION.get() || !(FreecamConfig.IGNORE_ALL_COLLISION.get() && canUseCheats()));
        freeCamera.spawn();
        MC.setCameraEntity(freeCamera);
